...
public class TestClassForFormSubmission {    //Read data from property file
    UTIL util=new UTIL();
    Properties prop = util.readPropData();
    String url = prop.getProperty("url");
    WebDriverWait wait;

    FormSubmissionFeature formFeature;

    public TestClassForFormSubmission() throws IOException {
    }

    @BeforeTest
    public void init() throws Exception {
        formFeature = new FormSubmissionFeature();
